...
export default function CardService({
  ...
  return (
    <Card className="w-full sm:w-[22rem] mx-auto border border-gray-200 rounded-xl p-6  hover:shadow-red-200 transition-all duration-300 transform hover:-translate-y-2 group">
